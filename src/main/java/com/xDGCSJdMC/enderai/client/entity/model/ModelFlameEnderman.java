package com.xDGCSJdMC.enderai.client.entity.model;

import net.minecraft.client.model.ModelBiped;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class ModelFlameEnderman extends ModelBiped {
	
	/** Is the flameenderman carrying a block? */
    public boolean isCarrying;
    /** Is the flameenderman attacking an entity? */
    public boolean isAttacking;
	
	public ModelFlameEnderman()
    {
