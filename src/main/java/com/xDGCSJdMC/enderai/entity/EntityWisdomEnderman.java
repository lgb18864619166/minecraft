...
public class EntityWisdomEnderman extends EntityEnderman{
	...
	public EntityWisdomEnderman(World worldIn)
    {
        super(worldIn);
    }
    ...
    protected void dropFewItems(boolean arg1, int arg2)
    {
        if (this.rand.nextInt(5) == 0)
        {
            ...
            this.dropItem(ItemLoader.wisdomPearl, 1);
            this.dropItem(ItemLoader.chaoticPearlPellet, 1);
            this.dropItem(ItemLoader.endermanHelmet, 1);
        }
    ...
    private void registerEntitySpawn(Class<EntityWisdomEnderman> class1, int i, int j, int k, EnumCreatureType monster,
